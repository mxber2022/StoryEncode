          ...
          <div className="bg-gray-900 border border-gray-700 rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="flex justify-end space-x-3 pt-4 border-t border-gray-700">
                ...
                <button className="flex items-center space-x-2 px-4 py-2 bg-gradient-to-r from-gray-600 via-gray-500 to-gray-600 text-white rounded-lg hover:from-gray-500 hover:via-gray-400 hover:to-gray-500 transition-all duration-300 shadow-lg hover:shadow-xl border border-gray-500/30">
